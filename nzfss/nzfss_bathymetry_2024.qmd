...
-   Depth data were interpolated using a Multilevel B-Spline Approximation (MBA) algorithm. ::: {.fragment}
-   Hypsographic curves were calculated for each lake. :::
-   Comparison of depth and area with other databases. ::: {.fragment}
...
## Depth-area relationship {.smaller .unnumbered .unlisted data-name="Results"}
...
## Breakdown by geomorphic type {.smaller .unnumbered .unlisted}
