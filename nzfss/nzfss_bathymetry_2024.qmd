...
## Lake depth-area relationship {.smaller data-name="Results" .unnumbered .unlisted}
...
p <- ggplot() +
  geom_point(data = lake_summ, aes(x = area_Ha, y = z_max, color = lat,
                                   size = elevation)) +
...
# plot_ly() |> 
#   add_markers(data = lake_summ, x = ~area_Ha, y = ~z_max, color = ~lat,
#               size = ~elevation, colors = c("#73D2DE", "#FFBC42", "#D81159"),
#               hoverinfo = "text",
#               text = paste0("Lake: ", lake_summ$name_final, "<br>",
#                             "Area: ", round(lake_summ$area_Ha, 1), " Ha<br>",
#                             "Max depth: ", round(lake_summ$z_max, 1), " m<br>",
#                             "Latitude: ", round(lake_summ$lat, 1), "°<br>",
#                             "Elevation: ", round(lake_summ$elevation, 1), " m")) |> 
#   layout(xaxis = list(title = "Surface area (Ha)", type = "log"),
#          yaxis = list(title = "Max depth (m)", type = "log"),
#          legend = list(orientation = "h", x = 0.2, y = -0.2)) |> 
...
## Lake depth-area & geomorphic type relationship {.smaller .unnumbered .unlisted}
...
p <- ggplot() +
  geom_point(data = lake_summ, aes(x = area_Ha, y = z_max, color = GeomorphicType)) +
  geom_smooth(data = lake_summ, aes(x = area_Ha, y = z_max, color = GeomorphicType),
              method = "lm", se = FALSE) +
