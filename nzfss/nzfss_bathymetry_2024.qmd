...
p <- ggplot() +
  ...
  labs(y = "Count", x = "Depth (m)", fill = "Geomorphic\ntype")+
...
## Bathymetry example: Lake Rotoma {.smaller .unnumbered .unlisted}
...
bathytools::plot_raster_3d(x = bathy, cols = "bathy", shoreline = shoreline)
