...
#   geom_point(aes(area_Ha, z_max, colour = lat,# shape = form_DV,
#                  size = elevation), alpha = 0.8) +
#   theme_bw() +
#   scale_x_log10() +
#   scale_y_log10() +
#   annotation_logticks() +
...
#   labs(x = "Surface area (Ha)", y = "Max depth (m)", colour = "Latitude",
#        size = "Elevation (m)", shape = "Form") +
