...
format: 
  revealjs:
    ...
    simplemenu:
        flat: true
        barhtml:
            header: "<div class='menubar'><a class='logo' href='#'><img src='img/www/limnotrack_border.jpg'></a><ul class='menu'></ul><div class='slide-number'></div><div>"
        scale: 0.8
revealjs-plugins:
    - simplemenu
author:
...
## Overview {data-state="hide-menubar"}
...
## Predicting mean and max depth {.smaller data-name="Results"}
